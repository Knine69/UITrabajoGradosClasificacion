        ...
        <div className="flex flex-col mb-0.5 mt-5 dark:bg-slate-600 shadow-2xl w-5/6 rounded-md p-8">
            <div className=' h-96 overflow-y-scroll no-scrollbar'>
                {paragraphs.map((paragraph, index) => (
                    ...
                    >
                        <div
                            className={`text-l font-medium focus:border-blue-900 focus:ring-blue-900 w-auto overflow-scroll overscroll-auto p-3 rounded text-white ${paragraph.emitter === 'user'
                                ? 'bg-[#1e1b4b]'
                                : 'bg-[#4a044e]'
                                }`}
                        >
